...
public class ExampleEntityAnimations {
    public static final AnimationDefinition ANIM_EXAMPLE_ENTITY_WALK = AnimationDefinition.Builder.create(2f).looping()
    ...
    public static final AnimationDefinition ANIM_EXAMPLE_ENTITY_IDLE = AnimationDefinition.Builder.create(20.0F).looping()
            .addBoneAnimation("head", new Transformation(Transformation.Targets.ROTATE,
